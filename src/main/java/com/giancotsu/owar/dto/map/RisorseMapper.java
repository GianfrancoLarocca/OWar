...
public class RisorseMapper {
    ...
    public static List<RisorsaDto> mapToDto(PlayerRisorse pr) {
        ...
        metalloDto.setQuantitaLunga(pr.getMetallo().valueShort());
        ...
        microchipDto.setQuantitaLunga(pr.getMicrochip().valueShort());
        ...
        energiaDto.setQuantitaLunga(pr.getEnergia().valueShort());
        ...
        civiliDto.setQuantitaLunga(pr.getCivili().valueShort());
        ...
        bitcoinDto.setQuantitaLunga(pr.getBitcoin().valueShort());
        ...
        acquaDto.setQuantitaLunga(pr.getAcqua().valueShort());
